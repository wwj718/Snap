var snapVersion = '8.3.0-dev',
    ...
    filesToCache = [
        ...
        'libraries/Adapter_EIM_lib.xml',
        'libraries/Python_lib.xml',
        'libraries/dotPack_lib.xml',
        "libraries/Elite_Extensions.js",
        'libraries/Elite_AI_Training.xml',
        'libraries/Elite_Speechcx.xml',
        'libraries/microblocks_messaging_library.xml',
        'libraries/HCI_lib.xml',
        'libraries/Kano_Wand.xml',
        'libraries/AlphaMini_lib.xml',
        'libraries/USB_microbit_lib.xml',
        'libraries/RoboMasterEP_lib.xml',
        'libraries/DymamicTable_lib.xml',
